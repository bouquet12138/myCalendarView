...
public class SolarLunarConverter {
     ...
     * 公历转农历
     */
    public static DateBean SolarToLunar(int year, int month, int day) {

        DateBean dateBean = isSolarFestival(month, day);
        ...
        DateBean dateBean1 = isLunarFestival(lunarMonth, lunarDay, day);
        ...
        if (!TextUtils.isEmpty(solarTerm))
            return new DateBean(day, false, solarTerm);

        return new DateBean(day, false, getLunar(lunarMonth, lunarDay));
    }
     ...
     * @return
     */
    private static DateBean isLunarFestival(int lunarMonth, int lunarDay, int day) {

        if (lunarMonth == 1 && lunarDay == 1)
            return new DateBean(day, true, "春节");
        if (lunarMonth == 1 && lunarDay == 15)
            return new DateBean(day, false, "元宵节");
        if (lunarMonth == 1 && lunarDay == 15)
            return new DateBean(day, true, "端午节");
        if (lunarMonth == 7 && lunarDay == 7)
            return new DateBean(day, false, "七夕节");
        if (lunarMonth == 7 && lunarDay == 15)
            return new DateBean(day, false, "中元节");
        if (lunarMonth == 8 && lunarDay == 15)
            return new DateBean(day, true, "中秋节");
        if (lunarMonth == 9 && lunarDay == 9)
            return new DateBean(day, false, "重阳节");
        if (lunarMonth == 10 && lunarDay == 1)
            return new DateBean(day, false, "寒衣节");
        if (lunarMonth == 10 && lunarDay == 15)
            new DateBean(day, false, "下元节");
        if (lunarMonth == 12 && lunarDay == 8)
            return new DateBean(day, false, "腊八节");
        if (lunarMonth == 12 && lunarDay == 29)
            return new DateBean(day, true, "除夕");
     ...
     * @return
     */
    private static DateBean isSolarFestival(int month, int day) {

        if (month == 1 && day == 1)
            return new DateBean(day, true, "元旦");
        if (month == 2 && day == 14)
            return new DateBean(day, false, "情人节");
        if (month == 3 && day == 8)
            return new DateBean(day, false, "妇女节");
        if (month == 3 && day == 12)
            return new DateBean(day, false, "植树节");
        if (month == 4 && day == 1)
            return new DateBean(day, false, "愚人节");
        if (month == 4 && day == 5)
            return new DateBean(day, true, "清明节");
        if (month == 4 && day == 22)
            return new DateBean(day, false, "地球日");
        if (month == 5 && day == 1)
            return new DateBean(day, true, "劳动节");
        if (month == 5 && day == 4)
            return new DateBean(day, false, "五四青年节");
        if (month == 6 && day == 1)
            return new DateBean(day, false, "儿童节");
        if (month == 6 && day == 23)
            return new DateBean(day, false, "奥林匹克日");
        if (month == 7 && day == 1)
            return new DateBean(day, false, "建党日");
        if (month == 8 && day == 1)
            return new DateBean(day, false, "建军节");
        if (month == 9 && day == 10)
            return new DateBean(day, false, "教师节");
        if (month == 10 && day == 1)
            return new DateBean(day, true, "国庆节");
        if (month == 11 && day == 28)
            return new DateBean(day, false, "感恩节");
        if (month == 12 && day == 1)
            return new DateBean(day, false, "艾滋病日");
        if (month == 12 && day == 13)
            return new DateBean(day, false, "国家公祭日");
        if (month == 12 && day == 24)
            return new DateBean(day, false, "平安夜");
        if (month == 12 && day == 25)
            return new DateBean(day, false, "圣诞节");
